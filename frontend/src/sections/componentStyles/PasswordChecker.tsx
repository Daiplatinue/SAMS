...
export default function PasswordChecker({ name, value, onChange }: PasswordCheckerProps) {
  ...
  return (
    <div>
      ...
      <p id="password-strength" className="mb-2 text-sm font-medium text-foreground text-zinc-300">
        {getStrengthText(strengthScore)} Must contain the following:
      </p>
